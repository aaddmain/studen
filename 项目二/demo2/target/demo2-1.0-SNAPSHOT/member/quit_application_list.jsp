    ...
    <div class="main-container">
            ...
            <nav>
                <ul class="sidebar-nav">
                    ...
                    <c:if test="${isPresidentOrVice}">
                        ...
                        <li>
                            <a href="/demo2_war_exploded/member?action=quitApplicationList" class="active">
                                <i class="fa fa-list-alt"></i>
                                <span>退出申请列表</span>
                            </a>
                        </li>
        ...
        <main class="main-content">
            ...
            <div class="content">
                ...
                <!-- 页面标题 -->
                <h1 class="page-title">
                    <i class="fa fa-list-alt"></i> 退出申请列表
                </h1>
                ...
                <div class="table-container">
                    <table class="table">
                        ...
                        <tbody>
                            <c:choose>
                                <c:when test="${not empty quitApplications}">
                                    <c:forEach items="${quitApplications}" var="application">
                                        <tr>
                                            <td>${application.memberStudentId}</td>
                                            <td>${application.studentName}</td>
                                            <td>${application.memberSocietyId}</td>
                                            <td>${application.societyName}</td>
                                            <td>${application.memberUpdateTime}</td>
                                            <td>
                                ...
                                <c:otherwise>
                                    <tr>
                                        <td colspan="6" style="text-align: center; color: #999; padding: 50px;">
                                            <i class="fa fa-info-circle"></i> 暂无退出申请
                                        </td>
                                    </tr>
                                </c:otherwise>
                            </c:choose>
