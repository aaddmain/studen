                ...
                <div class="form-container">
                    <form action="/demo2_war_exploded/society" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="societyName" name="societyName" placeholder="请输入协会名称" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label" for="societyCreator">创始人ID</label>
                            <input type="number" class="form-control" id="societyCreator" name="societyCreator" placeholder="请输入创始人ID" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label" for="societyIntro">协会简介</label>
                            <textarea class="form-control" id="societyIntro" name="societyIntro" placeholder="请输入协会简介" required></textarea>
                        </div>
