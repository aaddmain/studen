    ...
    <div class="panel">
        ...
        <div class="panel-body">
            <form action="/student/queryStudent" method="post">
                姓名：<input type="text" class="form-control" name="studentName" placeholder="请输入姓名"><br>
                学号：<input type="number" class="form-control" name="studentNumber" placeholder="请输入学号"><br>
